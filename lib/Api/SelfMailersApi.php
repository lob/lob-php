...
/**
 * SelfMailersApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SelfMailersApi
{
     ...
     * create
     *
     * @param  \OpenAPI\Client\Model\SelfMailerEditable $self_mailer_editable self_mailer_editable (required)
     ...
     * @return \OpenAPI\Client\Model\SelfMailer|\OpenAPI\Client\Model\LobError
     */
    public function create($self_mailer_editable, $idempotency_key = null)
    {
        $response = $this->createWithHttpInfo($self_mailer_editable, $idempotency_key);
        return $response;
    }
     ...
     * create
     *
     * @param  \OpenAPI\Client\Model\SelfMailerEditable $self_mailer_editable (required)
     * @param  string $idempotency_key A string of no longer than 256 characters that uniquely identifies this resource. For more help integrating idempotency keys, refer to our [implementation guide](https://www.lob.com/guides#idempotent_request). (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SelfMailer|\OpenAPI\Client\Model\LobError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($self_mailer_editable, $idempotency_key = null)
    {
        $request = $this->createRequest($self_mailer_editable, $idempotency_key);
        ...
        try {
            ...
            return ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SelfMailer', []);
     ...
     */
    public function createRequest($self_mailer_editable, $idempotency_key = null)
    {
        // verify the required parameter 'self_mailer_editable' is set
        if ($self_mailer_editable === null || (is_array($self_mailer_editable) && count($self_mailer_editable) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $self_mailer_editable when calling create'
            );
        }
        if ($idempotency_key !== null && strlen($idempotency_key) > 256) {
            throw new \InvalidArgumentException('invalid length for "$idempotency_key" when calling SelfMailersApi.create, must be smaller than or equal to 256.');
        }


        $resourcePath = '/self_mailers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($self_mailer_editable)) {
            $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($self_mailer_editable));
        }
     ...
     * delete
     *
     * @param  string $sfm_id id of the self_mailer (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SelfMailerDeletion|\OpenAPI\Client\Model\LobError
     */
    public function delete($sfm_id)
    {
        $response = $this->deleteWithHttpInfo($sfm_id);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SelfMailerDeletion|\OpenAPI\Client\Model\LobError, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteWithHttpInfo($sfm_id)
    {
        $request = $this->deleteRequest($sfm_id);
        ...
        try {
            ...
            // Since all non successes are thrown above, we can assume success
            $content = (string) $response->getBody();
            return ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SelfMailerDeletion', []);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRequest($sfm_id)
    {
        // verify the required parameter 'sfm_id' is set
        if ($sfm_id === null || (is_array($sfm_id) && count($sfm_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sfm_id when calling delete'
            );
        }
        if (!preg_match("/^sfm_[a-zA-Z0-9]+$/", $sfm_id)) {
            throw new \InvalidArgumentException("invalid value for \"sfm_id\" when calling SelfMailersApi.delete, must conform to the pattern /^sfm_[a-zA-Z0-9]+$/.");
        }


        $resourcePath = '/self_mailers/{sfm_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($sfm_id !== null) {
            $resourcePath = str_replace(
                '{' . 'sfm_id' . '}',
                ObjectSerializer::toPathValue($sfm_id),
                $resourcePath
            );
        }
     ...
     * @return \OpenAPI\Client\Model\SelfMailer|\OpenAPI\Client\Model\LobError
     */
    public function get($sfm_id)
    {
        $response = $this->getWithHttpInfo($sfm_id);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\SelfMailer|\OpenAPI\Client\Model\LobError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($sfm_id)
    {
        $request = $this->getRequest($sfm_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRequest($sfm_id)
    {
        // verify the required parameter 'sfm_id' is set
        if ($sfm_id === null || (is_array($sfm_id) && count($sfm_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sfm_id when calling get'
            );
        }
        if (!preg_match("/^sfm_[a-zA-Z0-9]+$/", $sfm_id)) {
            throw new \InvalidArgumentException("invalid value for \"sfm_id\" when calling SelfMailersApi.get, must conform to the pattern /^sfm_[a-zA-Z0-9]+$/.");
        }
     ...
     * @param  \OpenAPI\Client\Model\SelfMailerSize[] $size The self mailer sizes to be returned. (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SelfMailerList|\OpenAPI\Client\Model\LobError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SelfMailerList|\OpenAPI\Client\Model\LobError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listWithHttpInfo($limit = 10, $before = null, $after = null, $include = null, $date_created = null, $metadata = null, $size = null, $scheduled = null, $send_date = null, $mail_type = null, $sort_by = null)
    {
        ...
        try {
            ...
            // Since all non successes are thrown above, we can assume success
            $content = (string) $response->getBody();
            return ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SelfMailerList', []);
    ...
    public function listRequest($limit = 10, $before = null, $after = null, $include = null, $date_created = null, $metadata = null, $size = null, $scheduled = null, $send_date = null, $mail_type = null, $sort_by = null)
    {
        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling SelfMailersApi.list, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling SelfMailersApi.list, must be bigger than or equal to 1.');
        }

        if ($metadata !== null && strlen($metadata) > 500) {
            throw new \InvalidArgumentException('invalid length for "$metadata" when calling SelfMailersApi.list, must be smaller than or equal to 500.');
        }
        if ($metadata !== null && !preg_match("/[^\"\\\\]{0,500}/", $metadata)) {
            throw new \InvalidArgumentException("invalid value for \"metadata\" when calling SelfMailersApi.list, must conform to the pattern /[^\"\\\\]{0,500}/.");
        }
