...
class DefaultApi
{
     ...
     * @return \OpenAPI\Client\Model\PlaceholderModel
     */
    public function placeholder_no_call()
    {
        $response = $this->placeholder_no_callWithHttpInfo();
        return $response;
    }

    /**
     * Operation placeholder_no_callWithHttpInfo
     *
     * placeholder_no_call
     *
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PlaceholderModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeholder_no_callWithHttpInfo()
    {
        $request = $this->placeholder_no_callRequest();
        ...
        try {
            ...
            return ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PlaceholderModel', []);
    ...
    /**
     * Create request for operation 'placeholder_no_call'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeholder_no_callRequest()
    {

        $resourcePath = '/shared_dont_call';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
