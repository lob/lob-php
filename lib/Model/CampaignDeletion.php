...
/**
 * CampaignDeletion Class Doc Comment
 *
 * @category Class
 ...
 */
class CampaignDeletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'campaign_deletion';
    ...
    public function setId($id)
    {
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            ...
            if (!is_null($id) && (!preg_match("/^cmp_[a-zA-Z0-9]+$/", $id))) {
                throw new \InvalidArgumentException("invalid value for $id when calling CampaignDeletion., must conform to the pattern /^cmp_[a-zA-Z0-9]+$/.");
            }
