...
/**
 * PostcardRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostcardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postcard_request';
    ...
    protected static $openAPITypes = [
        ...
        'details' => '\OpenAPI\Client\Model\PostcardDetailsWritable',
    ...
    public function setDescription($description)
    {
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            if (!is_null($description) && (mb_strlen($description) > 255)) {
                throw new \InvalidArgumentException('invalid length for $description when calling PostcardRequest., must be smaller than or equal to 255.');
            }
    ...
    public function setCampaignId($campaign_id)
    {
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            ...
            if (!is_null($campaign_id) && (!preg_match("/^cmp_[a-zA-Z0-9]+$/", $campaign_id))) {
                throw new \InvalidArgumentException("invalid value for $campaign_id when calling PostcardRequest., must conform to the pattern /^cmp_[a-zA-Z0-9]+$/.");
            }
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\PostcardDetailsWritable|null $details details
     *
     * @return self
     */
