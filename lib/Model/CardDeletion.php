...
class CardDeletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((!function_exists($this->getId()) || strpos($this->getId(), "fakeId") === False) && !is_null($this->container['id']) && !preg_match("/^card_[a-zA-Z0-9]+$/", $this->container['id'])) {
    ...
    public function setId($id)
    {
        ...
        if (strpos($this->getId(), "fakeId") === False && !is_null($id) && (!preg_match("/^card_[a-zA-Z0-9]+$/", $id))) {
