...
/**
 * TemplateUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TemplateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'template_update';
     ...
     *
     * @param string|null $published_version Unique identifier prefixed with `vrsn_`.
     *
     * @return self
     */
