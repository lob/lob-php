...
/**
 * TemplateDeletion Class Doc Comment
 *
 * @category Class
 ...
 */
class TemplateDeletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'template_deletion';
    ...
    const OBJECT_TEMPLATE_DELETED = 'template_deleted';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((!function_exists($this->getId()) || strpos($this->getId(), "fakeId") === False) && !is_null($this->container['id']) && !preg_match("/^tmpl_[a-zA-Z0-9]+$/", $this->container['id'])) {
