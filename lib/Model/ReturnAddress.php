...
class ReturnAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'return_address';
    ...
    public function setAddressLine1($address_line1)
    {
        if (!is_null($address_line1) && (mb_strlen($address_line1) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling ReturnAddress., must be smaller than or equal to 200.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling ReturnAddress., must be smaller than or equal to 200.');
        }
    ...
    public function setAddressCity($address_city)
    {
        if (!is_null($address_city) && (mb_strlen($address_city) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling ReturnAddress., must be smaller than or equal to 200.');
        }
    ...
    public function setAddressState($address_state)
    {
        if (!is_null($address_state) && (mb_strlen($address_state) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address_state when calling ReturnAddress., must be smaller than or equal to 200.');
        }
    ...
    public function setAddressZip($address_zip)
    {
        if (!is_null($address_zip) && (mb_strlen($address_zip) > 40)) {
            throw new \InvalidArgumentException('invalid length for $address_zip when calling ReturnAddress., must be smaller than or equal to 40.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ReturnAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReturnAddress., must be smaller than or equal to 40.');
        }
    ...
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 40)) {
            throw new \InvalidArgumentException('invalid length for $company when calling ReturnAddress., must be smaller than or equal to 40.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 40)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ReturnAddress., must be smaller than or equal to 40.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ReturnAddress., must be smaller than or equal to 100.');
        }
