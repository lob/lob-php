...
/**
 * SelfMailerDeletion Class Doc Comment
 *
 * @category Class
 ...
 */
class SelfMailerDeletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'self_mailer_deletion';
    ...
    const OBJECT_SELF_MAILER_DELETED = 'self_mailer_deleted';
    ...
    {
        return [
            self::OBJECT_SELF_MAILER_DELETED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ((!function_exists($this->getId()) || strpos($this->getId(), "fakeId") === False) && !is_null($this->container['id']) && !preg_match("/^sfm_[a-zA-Z0-9]+$/", $this->container['id'])) {
