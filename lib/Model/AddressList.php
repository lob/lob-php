 ...
 */
class AddressList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'address_list';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\Address[]',
        'object' => 'string',
        'next_url' => 'string',
        'previous_url' => 'string',
        'count' => 'int',
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Address[]|null $data list of addresses
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ($data) {
            foreach ($data as $point) {
                $deserializedData = ObjectSerializer::deserialize($point, '\OpenAPI\Client\Model\Address', []);
