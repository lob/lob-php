...
/**
 * TemplateVersionList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TemplateVersionList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'template_version_list';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\TemplateVersion[]',
        'object' => 'string',
        'next_url' => 'string',
        'previous_url' => 'string',
        'count' => 'int',
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\TemplateVersion[]|null $data list of template versions
     *
     * @return self
     */
