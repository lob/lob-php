...
class CheckList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'check_list';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\Check[]',
        'object' => 'string',
        'next_url' => 'string',
        'previous_url' => 'string',
        'count' => 'int',
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Check[]|null $data list of checks
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ($data) {
            foreach ($data as $point) {
                $deserializedData = ObjectSerializer::deserialize($point, '\OpenAPI\Client\Model\Check', []);
