...
/**
 * PostcardDeletion Class Doc Comment
 *
 * @category Class
 ...
 */
class PostcardDeletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postcard_deletion';
    ...
    const OBJECT_POSTCARD_DELETED = 'postcard_deleted';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((!function_exists($this->getId()) || strpos($this->getId(), "fakeId") === False) && !is_null($this->container['id']) && !preg_match("/^psc_[a-zA-Z0-9]+$/", $this->container['id'])) {
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier prefixed with `psc_`.
     *
     * @return self
     */
