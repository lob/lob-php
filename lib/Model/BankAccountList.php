...
class BankAccountList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bank_account_list';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\BankAccount[]',
        'object' => 'string',
        'next_url' => 'string',
        'previous_url' => 'string',
        'count' => 'int',
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\BankAccount[]|null $data list of addresses
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ($data) {
            foreach ($data as $point) {
                $deserializedData = ObjectSerializer::deserialize($point, '\OpenAPI\Client\Model\BankAccount', []);
