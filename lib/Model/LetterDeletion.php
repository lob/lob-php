...
/**
 * LetterDeletion Class Doc Comment
 *
 * @category Class
 ...
 */
class LetterDeletion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'letter_deletion';
    ...
    const OBJECT_LETTER_DELETED = 'letter_deleted';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((!function_exists($this->getId()) || strpos($this->getId(), "fakeId") === False) && !is_null($this->container['id']) && !preg_match("/^ltr_[a-zA-Z0-9]+$/", $this->container['id'])) {
