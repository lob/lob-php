...
/**
 * CampaignCreative Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignCreative implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'campaign_creative';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            if (!is_null($this->container['campaigns']) && (count($this->container['campaigns']) > 0)) {
                $invalidProperties[] = "invalid value for 'campaigns', number of items must be less than or equal to 0.";
            }

            if (!is_null($this->container['campaigns']) && (count($this->container['campaigns']) < 0)) {
                $invalidProperties[] = "invalid value for 'campaigns', number of items must be greater than or equal to 0.";
            }
    ...
    public function setId($id)
    {
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            ...
            if (!is_null($id) && (!preg_match("/^crv_[a-zA-Z0-9]+$/", $id))) {
                throw new \InvalidArgumentException("invalid value for $id when calling CampaignCreative., must conform to the pattern /^crv_[a-zA-Z0-9]+$/.");
            }
    ...
    public function setDescription($description)
    {
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            if (!is_null($description) && (mb_strlen($description) > 255)) {
                throw new \InvalidArgumentException('invalid length for $description when calling CampaignCreative., must be smaller than or equal to 255.');
            }
     ...
     * Sets details
     *
     * @param mixed|null $details Either PostcardDetailsReturned or LetterDetailsReturned
     *
     * @return self
     */
     ...
     * Sets campaigns
     *
     * @param \OpenAPI\Client\Model\Campaign[]|null $campaigns campaigns
     *
     * @return self
     */
    public function setCampaigns($campaigns)
    {
        if (!method_exists($this, 'getId') || (!empty($this->getId()) && strpos($this->getId(), "fakeId") === False)) {
            ...
            if (!is_null($campaigns) && (count($campaigns) > 0)) {
                throw new \InvalidArgumentException('invalid value for $campaigns when calling CampaignCreative., number of items must be less than or equal to 0.');
            }
            if (!is_null($campaigns) && (count($campaigns) < 0)) {
                throw new \InvalidArgumentException('invalid length for $campaigns when calling CampaignCreative., number of items must be greater than or equal to 0.');
            }
        }
