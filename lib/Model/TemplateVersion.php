...
class TemplateVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/^vrsn_[a-zA-Z0-9]+$/", $this->container['id'])) {
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier prefixed with `vrsn_`.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^vrsn_[a-zA-Z0-9]+$/", $id))) {
