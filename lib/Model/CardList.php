...
class CardList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'card_list';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\Card[]',
        'object' => 'string',
        'next_url' => 'string',
        'previous_url' => 'string',
        'count' => 'int',
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Card[]|null $data list of cards
     *
     * @return self
     */
    public function setData($data)
    {
        ...
        if ($data) {
            foreach ($data as $point) {
                $deserializedData = ObjectSerializer::deserialize($point, '\OpenAPI\Client\Model\Card', []);
